...
namespace Weixsu.Orleans.Transactions.AdoNet
{
    public static class HostingExtensions
    {
            ...
            Action<OptionsBuilder<TransactionalStateStorageOptions>> configureOptions = null)
        {
            ...
            services.TryAddSingleton(sp => sp.GetServiceByName<ITransactionalStateStorageFactory>(name));
            services.AddSingletonNamedService(name, TransactionalStateStorageFactory.Create);
