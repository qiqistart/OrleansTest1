...
namespace Weixsu.Orleans.Transactions.AdoNet
{
    public class TransactionalStateStorageFactory : ITransactionalStateStorageFactory, ILifecycleParticipant<ISiloLifecycle>
    {
            ...
            IGrainFactory grainFactory)
        {
            ...
            jsonSerializerSettings = TransactionalStateFactory.GetJsonSerializerSettings(typeResolver, grainFactory);
            ...
            IGrainActivationContext context) where TState : class, new()
        {
            ...
            var stateId = $"{grainKey}_{clusterOptions.ServiceId}_{stateName}";
            ...
            return ActivatorUtilities.CreateInstance<TransactionalStateStorage<TState>>(
                context.ActivationServices, stateId, jsonSerializerSettings, options, dbOperator, logger);
        }
        ...
        {
            lifecycle.Subscribe(OptionFormattingUtilities.Name<TransactionalStateStorageFactory>(name), ServiceLifecycleStage.ApplicationServices, Init);
        }
